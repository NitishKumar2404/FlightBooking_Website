...
class BagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bag" do
    assert_difference('Bag.count') do
      post bags_url, params: { bag: { bag_id: @bag.bag_id, cost: @bag.cost, weight: @bag.weight } }
    end
  ...
  test "should update bag" do
    patch bag_url(@bag), params: { bag: { bag_id: @bag.bag_id, cost: @bag.cost, weight: @bag.weight } }
